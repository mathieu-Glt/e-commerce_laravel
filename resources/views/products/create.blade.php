                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="more_description"
                                        class="block text-sm font-medium text-gray-700">Description détaillée</label>
                                    <textarea name="more_description" id="more_description" rows="5"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('more_description') }}</textarea>
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="regularPrice" class="block text-sm font-medium text-gray-700">Prix
                                        régulier</label>
                                ...
                                <div>
                                    <label for="soldePrice" class="block text-sm font-medium text-gray-700">Prix
                                        soldé</label>
                                    <input type="number" name="soldePrice" id="soldePrice" step="0.01" min="0"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        value="{{ old('soldePrice') }}">
                                </div>
                                ...
                                <div>
                                    <label for="quantity" class="block text-sm font-medium text-gray-700">Quantité
                                        minimale</label>
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                <label for="dimensions"
                                    class="block text-sm font-medium text-gray-700">Dimensions</label>
